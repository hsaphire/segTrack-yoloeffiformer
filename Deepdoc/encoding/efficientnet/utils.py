...
class MobileNetConv2d(nn.Module):
    def __init__(self, in_channels, out_channels,bias,stride,padding,dilation,groups):
...
def load_pretrained_weights(model, model_name, load_fc=True):
    ...
    state_dict = torch.load("Deepdoc/encoding/architecture/{}".format(eff[model_name]))
    if load_fc:
