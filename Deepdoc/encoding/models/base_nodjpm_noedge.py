...
from ..efficientNet.EfficientNet_PyTorch.efficientnet_pytorch import EfficientNet
...
class BaseNet(nn.Module):
    ...
    def __init__(self, nclass, backbone, aux, se_loss, jpu=True, dilated=False, norm_layer=None,
        ...
        self.jpu=False
        #DJPM
        # self.djpm = DJPM([32, 48, 136, 232, 384], width=256, up_kwargs=up_kwargs)#最左邊3個與最右邊3個，按照順序放（左到右）
    ...
    def base_forward(self, x):
        ...
        if self.backbone == 'efficientnet':
            ...
            return layer[-6],layer[-4], layer[-3], layer[-1]
